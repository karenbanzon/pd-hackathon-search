    ...
    <section class="expanded row padding-10">
        <div class="small-12 large-8 large-offset-2 padding-10">
            ...
            <div class="small-12 large-6 columns">
                <div class="input-group">
                    ...
                    <input class="input-group-field" type="text" placeholder="Ex. Asus Zenfone" value="lenvo laptop">
                </div>
            </div>
            <div class="small-12 large-6 columns">
                <div class="input-group">
        ...
        <div class="small-12 large-8 large-offset-2 padding-10">
            <div class="message-spelling">
                <p>Showing 1,900 results for <strong>lenovo laptop</strong>.
                <br>
                <small><a href="">Search instead for <strong>lenvo laptop</strong>.</a></small></p>
            </div>
        </div>
